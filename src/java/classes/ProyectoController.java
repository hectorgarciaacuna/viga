...
public class ProyectoController implements Serializable {
    ...
    @EJB
    private session.ProyectoFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/ProyectoBundle/Bundle").getString("ProyectoCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/ProyectoBundle/Bundle").getString("ProyectoUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/ProyectoBundle/Bundle").getString("ProyectoDeleted"));
        if (!JsfUtil.isValidationFailed()) {
        ...
        if (selected != null) {
            ...
            try {
                ...
                if (msg.length() > 0) {
                    ...
                    JsfUtil.addErrorMessage(ex, ResourceBundle.getBundle("/ProyectoBundle/Bundle").getString("PersistenceErrorOccured"));
                }
            } catch (Exception ex) {
